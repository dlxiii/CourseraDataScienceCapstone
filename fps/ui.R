...
shinyUI(   fluidPage(
    ...
    mainPanel(
        ...
        wellPanel(
            h4("Details"),
            HTML("<p> Github Repository <a href='https://github.com/dlxiii/CourseraDataScienceCapstone' target='_blank'>https://github.com/dlxiii/CourseraDataScienceCapstone</a></p>"),
            h4("Author:"),
            p("Yulong Wang")
        )
